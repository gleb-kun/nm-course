...
\begin{document}
	...
	Рассмотрим математическую модель, задаваясь функцией $\overline{z}\left(s\right)$ и аппаратной функцией $K\left(x,s\right)$, близкими к функции $z_{\text{exact}}\left(s\right)$ и аппаратной функции в соответствующих практических задачах.
